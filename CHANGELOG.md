...
- Documented the registry-aware sampled antiderivative fallback and its
...
- Documented exact polynomial absolute-value combinations with up to six
  independent terms and 64 sign branches.

## 2026-09-07

- Documented exact polynomial absolute-value combinations with up to five
  independent terms and 32 sign branches.
...
- Documented Explaining `v0.188.0` automatic generic dispatch for bounded
  two-dimensional variable-order fractional diffusion and wave PDE syntax.

## 2026-09-07

- Documented Explaining `v0.187.0` automatic generic dispatch for bounded
  three-dimensional constant-order fractional diffusion and wave PDE syntax.
...
- Documented Explaining `v0.177.0` automatic bounded coupled one-dimensional
  wave-PDE dispatch, compact multi-field syntax, and solver limitations.

## 2026-09-07

- Documented Explaining `v0.176.0` automatic bounded three-dimensional wave-PDE
  dispatch, compact field/face syntax, and solver limitations.

## 2026-09-07

- Documented Explaining `v0.175.0` automatic bounded two-dimensional wave-PDE
  dispatch, compact field/edge syntax, and solver limitations.
...
- Documented Explaining `v0.110.0` paired periodic endpoints for the 1D wave
  solver, wrapped stencils, and unpaired/nonlocal scope limits.

## 2026-09-06

- Documented Explaining `v0.109.0` corrected paired periodic faces for 3D
  parabolic problems, wrapped planes, and unpaired-face limits.
...
- Documented Explaining `v0.106.0` paired periodic edges for 2D elliptic
  problems, wrapped stencils, and unpaired/nonlocal scope limits.
...
- Documented Explaining `v0.76.0` bounded nonlinear Fredholm equations,
  Picard iteration, and explicit convergence semantics.
...
- Documented explicit partial results for undefined area and root samples.
- Added the ecosystem release and deployment checklist.
- Added dependency-free CI checks for relative Markdown links.
